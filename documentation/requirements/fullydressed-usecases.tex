...
\begin{titlepage}
    \centering
    % Add a logo
    {\Large \textbf{HawkTU Inventory Management System}} \\[8cm]
...
\begin{longtable}{|>{\raggedright\arraybackslash}m{0.25\linewidth}|m{0.75\linewidth}|}
\hline
\textbf{Use Case Name} & Add Product Listings \\
\hline
\textbf{Scope} & HawkTU Logistics and Delivery Management System \\
\hline
\textbf{Level} & User Goal \\
...
\section*{Delete and Edit Product Listings}
...
\begin{longtable}{|>{\raggedright\arraybackslash}m{0.25\linewidth}|m{0.75\linewidth}|}
\hline
\textbf{Use Case Name} & Delete and Edit Product Listings \\
\hline
\textbf{Scope} & HawkTU Logistics and Delivery Management System \\
\hline
\textbf{Level} & User Goal \\
...
\textbf{Stakeholders and Interests} & 
\begin{itemize}
    \item Seller: Wants to efficiently manage product listings by removing unavailable products and updating product details to maintain accuracy.
    \item Customer: Expects an accurate and updated product catalogue to make informed purchasing decisions.
    \item System Administrator: Ensures data integrity and prevents errors in the product catalogue.
\end{itemize} \\
\hline
\textbf{Preconditions} & 
\begin{itemize}
    \item The seller is logged into the system.
    \item The seller has access to the product management interface.
    \item The product exists in the catalogue for deletion or editing.
\end{itemize} \\
\hline
\textbf{Postconditions} & 
\begin{itemize}
    \item The product listing is either updated or removed from the system.
    \item Changes are saved securely in the database and reflected in the catalogue.
\end{itemize} \\
\hline
\end{longtable}
...
\multicolumn{1}{|>{\centering\arraybackslash}m{0.5\linewidth}|}{\textbf{Actor Action (or Intention)}} & \multicolumn{1}{>{\centering\arraybackslash}m{0.5\linewidth}|}{\textbf{System Responsibility}} \\
\hline
1. Seller navigates to the product management section. & 2. System displays the product listings interface with available options. \\
\hline
3. Seller selects a product to delete or edit. & 4. System displays the product details. \\
\hline
\textbf{For Deletion:} Seller confirms the deletion action. & \textbf{For Deletion:} System removes the product from the database and updates the catalogue. \\
\hline
\textbf{For Editing:} Seller updates relevant product details. & \textbf{For Editing:} System validates the new details and updates the product in the database. \\
\hline
\multicolumn{2}{|c|}{\textbf{Extensions}} \\
\hline
\multicolumn{1}{|>{\centering\arraybackslash}m{0.5\linewidth}|}{\textbf{Actor Action (or Intention)}} & \multicolumn{1}{>{\centering\arraybackslash}m{0.5\linewidth}|}{\textbf{System Responsibility}} \\
\hline
\textbf{3a.} If the seller selects a non-existent product for deletion or editing. & \textbf{3a.} System displays an error message stating "Product not found." \\
\hline
\textbf{4a.} If the product details entered during editing are incomplete or invalid. & \textbf{4a.} System prompts the seller to provide complete and valid details. \\
\hline
\textbf{4b.} If the system fails to update or delete due to server issues. & \textbf{4b.} System notifies the seller of the failure and advises retrying later. \\
\hline
\end{longtable}
...
\begin{itemize}
    ...
    \item Points are redeemed, generating a coupon code that can be applied during future checkouts.
\end{itemize} \\
\hline
\end{longtable}
...
\hline
5. Customer chooses to redeem points. & 6. System validates the redemption request and deducts the appropriate number of points. \\
\hline
7. Customer receives a coupon code. & 8. System generates a unique coupon code and stores it in the customer’s account for future use. \\
\hline
\multicolumn{2}{|c|}{\textbf{Extensions}} \\
\hline
\multicolumn{1}{|>{\centering\arraybackslash}m{0.5\linewidth}|}{\textbf{Actor Action (or Intention)}} & \multicolumn{1}{>{\centering\arraybackslash}m{0.5\linewidth}|}{\textbf{System Responsibility}} \\
...
\hline
\textbf{6a.} Points deduction fails. & \textbf{6a.} System notifies the customer of the failure and advises retrying. \\
\hline
\textbf{7a.} Coupon generation fails. & \textbf{7a.} System logs the failure and notifies the customer to contact support. \\
\hline
\textbf{8a.} Customer attempts to use an invalid coupon code at checkout. & \textbf{8a.} System notifies the customer of the invalid code and prompts them to try again or contact support. \\
\hline
\end{longtable}

\newpage

\section*{Submit Product Reviews and Ratings}
...
\begin{longtable}{|>{\raggedright\arraybackslash}m{0.25\linewidth}|m{0.75\linewidth}|}
\hline
\textbf{Use Case Name} & Submit Product Reviews and Ratings \\
\hline
\textbf{Scope} & HawkTU Logistics and Delivery Management System \\
\hline
\textbf{Level} & User Goal \\
...
\textbf{Stakeholders and Interests} & 
\begin{itemize}
    \item Customer: Wants to provide honest feedback on products, helping others make informed decisions and ensuring quality products are highlighted.
    \item Seller: Gains insights into customer satisfaction and areas for improvement, enhancing product quality and reputation.
    \item Other Customers: Depend on reviews and ratings to evaluate product quality before purchasing.
    \item System Administrator: Monitors reviews to ensure compliance with community standards and prevents inappropriate content.
\end{itemize} \\
\hline
\textbf{Preconditions} & 
\begin{itemize}
    \item The customer is logged into the system.
    \item The customer has purchased or received the product being reviewed.
\end{itemize} \\
\hline
\textbf{Postconditions} & 
\begin{itemize}
    \item The product review and rating are submitted, stored in the database, and displayed under the respective product.
    \item The seller and other customers can view the review and rating.
\end{itemize} \\
\hline
\end{longtable}
...
\multicolumn{1}{|>{\centering\arraybackslash}m{0.5\linewidth}|}{\textbf{Actor Action (or Intention)}} & \multicolumn{1}{>{\centering\arraybackslash}m{0.5\linewidth}|}{\textbf{System Responsibility}} \\
\hline
1. Customer navigates to the product review section for a purchased product. & 2. System displays the product review submission form. \\
\hline
3. Customer writes a review and assigns a rating (e.g., 1-5 stars). & 4. System validates the input to ensure the review is within acceptable length and rating is within range. \\
\hline
5. Customer submits the review and rating. & 6. System saves the review and rating in the database and displays a success message. \\
\hline
7. Customer views the submitted review under the product details. & 8. System updates the product’s overall rating and adds the new review to the product’s review list. \\
\hline
\multicolumn{2}{|c|}{\textbf{Extensions}} \\
\hline
\multicolumn{1}{|>{\centering\arraybackslash}m{0.5\linewidth}|}{\textbf{Actor Action (or Intention)}} & \multicolumn{1}{>{\centering\arraybackslash}m{0.5\linewidth}|}{\textbf{System Responsibility}} \\
\hline
\textbf{3a.} If the review contains inappropriate content, the customer revises it. & \textbf{3a.} System detects inappropriate content using filters and prompts the customer to edit. \\
\hline
\textbf{5a.} If the customer tries to submit without a rating, they are prompted to provide one. & \textbf{5a.} System alerts the customer that a rating is mandatory. \\
\hline
\textbf{5b.} If the system fails to save the review due to server issues, the customer tries again later. & \textbf{5b.} System notifies the customer of the failure and advises retrying. \\
\hline
\end{longtable}
...
\multicolumn{1}{|>{\centering\arraybackslash}m{0.5\linewidth}|}{\textbf{Actor Action (or Intention)}} & \multicolumn{1}{>{\centering\arraybackslash}m{0.5\linewidth}|}{\textbf{System Responsibility}} \\
\hline
1. Customer or guest enters the tracking ID on the tracking page. & 2. System retrieves the order details associated with the tracking ID. \\
\hline
&3. System displays the current status and location of the order.\\
\hline 4. Customer or guest reviews the order status and estimated delivery time.& \\
\hline
\multicolumn{2}{|c|}{\textbf{Extensions}} \\
\hline
\multicolumn{1}{|>{\centering\arraybackslash}m{0.5\linewidth}|}{\textbf{Actor Action (or Intention)}} & \multicolumn{1}{>{\centering\arraybackslash}m{0.5\linewidth}|}{\textbf{System Responsibility}} \\
